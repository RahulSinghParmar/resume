...
\item{
        \textbf{Neyworking }{: VMware, AWS, PowerShell, Data backups, System upgrades, TCP/IP, DHCP, DNS, VPN, VLAN, Firewalls and VPNs, Network Administration }
      }
% \item{
%             \textbf{Technologies}{: RDP, AWS ec2, GitHub, Network Administration, Virtual Machine}
%       }
% \item{
...
%       }
% \item {
%             \textbf{language}{: \textit{\small \textbf{Native:}} Hindi \textit{\small \textbf{Fluent:}} English }
%       }
\resumeSubHeadingListEnd
